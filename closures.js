...
function motivation( firstname, lastname ) {
  ...
  function message(){return welcomeText + " " + firstname + " "+ lastname + "."}  // code message function here.
...
var module = (function() {
  ...
  return {
   publicMethod(){return privateMethod()} // Code here.
  };
})();
module.publicMethod()
